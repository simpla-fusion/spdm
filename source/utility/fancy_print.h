...
template <typename V>
std::ostream& fancy_print(std::ostream& os, V const* d, size_t ndims, size_t const* extents, int indent)
{
...
template <typename TI>
std::ostream& fancy_print_key_value(std::ostream& os, TI const& ib, TI const& ie, int indent, const std::string& kv_sep = "")
{
    if (ib == ie)
    {
        return os;
