...
namespace sp
{
    ...
    namespace detail
    {
        ...
        auto get_value(std::integer_sequence<size_type, IDX...>, V const &v, I const *idx)
        {
            return v(idx[IDX]...);
        };
    } // namespace detail
    ...
    std::ostream &fancy_print_nd_slow_first(std::ostream &os, TV const &v, int depth, index_type *idx, TI const *lo,
                                        ...
                                        std::string const &right_brace = "}")
    {
        ...
        else
        {
            ...
            idx[depth] = lo[depth];
            fancy_print_nd_slow_first<NDIMS>(os, v, depth + 1, idx, lo, hi, indent + 1, tab_width, left_brace, sep,
                                         right_brace);
    ...
    template <int NDIMS, typename TV, typename TI>
    std::ostream &fancy_print_nd_fast_first(std::ostream &os, TV const &v, int depth, index_type *idx, TI const *lo,
                                        TI const *hi, int indent = 0, int tab_width = 0,
                                        std::string const &left_brace = "{", std::string const &sep = ",",
                                        std::string const &right_brace = "}")
    {
        ...
        else
        {
            os << std::setw(indent) << left_brace << std::endl;
            idx[depth] = lo[depth];
            fancy_print_nd_fast_first<NDIMS>(os, v, depth - 1, idx, lo, hi, indent + 1, tab_width, left_brace, sep,
                                         right_brace);
    ...
    template <typename V>
    std::ostream &fancy_print(std::ostream &os, V const *d, size_type ndims, size_type const *extents, int indent)
    {
    ...
    std::ostream &fancy_print_array1(std::ostream &os, TI const &ib, TI const &ie, int indent = 0);

    template <typename TI>
    std::ostream &fancy_print_array1(std::ostream &os, TI const *d, int num, int indent = 0);

    template <typename TI>
    std::ostream &fancy_print_key_value(std::ostream &os, TI const &ib, TI const &ie, int indent = 0);
    ...
    template <typename T>
    std::ostream &fancy_print(std::ostream &os, T const &d, int indent, ENABLE_IF(std::rank<T>::value == 0))
    {
        os << d;
        return os;
    }
    ...
    inline std::ostream &fancy_print(std::ostream &os, bool const &d, int indent)
    {
        os << std::boolalpha << d;
        return os;
    }
    
    inline std::ostream &fancy_print(std::ostream &os, std::string const &s, int indent)
    {
        os << "\"" << s << "\"";
        return os;
    }
    ...
    template <typename T>
    std::ostream &fancy_print(std::ostream &os, const std::complex<T> &tv, int indent = 0)
    {
        os << "{" << tv.real() << "," << tv.imag() << "}";
        return (os);
    }
    ...
    std::ostream &fancy_print(std::ostream &os, std::pair<T1, T2> const &p, int indent = 0)
    {
        os << p.first << " = { " << p.second << " }";
        return (os);
    }
    ...
    template <typename T1, typename T2>
    std::ostream &fancy_print(std::ostream &os, std::map<T1, T2> const &p, int indent = 0)
    {
        for (auto const &v : p)
            os << v << "," << std::endl;
        return (os);
    ...
    std::ostream &fancy_print(std::ostream &os, std::vector<U, Others...> const &d, int indent = 0)
    {
        os << "[ ";
        fancy_print_array1(os, d.begin(), d.end(), indent);
        os << " ]";
        return os;
    }

    template <typename U, typename... Others>
    std::ostream &fancy_print(std::ostream &os, std::list<U, Others...> const &d, int indent = 0)
    {
        return fancy_print_array1(os, d.begin(), d.end(), indent);
    }

    template <typename U, typename... Others>
    std::ostream &fancy_print(std::ostream &os, std::set<U, Others...> const &d, int indent = 0)
    {
        return fancy_print_array1(os, d.begin(), d.end(), indent);
    }

    template <typename U, typename... Others>
    std::ostream &fancy_print(std::ostream &os, std::multiset<U, Others...> const &d, int indent = 0)
    {
        return fancy_print_array1(os, d.begin(), d.end(), indent);
    }

    template <typename TX, typename TY, typename... Others>
    std::ostream &fancy_print(std::ostream &os, std::map<TX, TY, Others...> const &d, int indent = 0)
    {
        return fancy_print_key_value(os, d.begin(), d.end(), indent);
    }

    template <typename TX, typename TY, typename... Others>
    std::ostream &fancy_print(std::ostream &os, std::multimap<TX, TY, Others...> const &d, int indent = 0)
    {
        return fancy_print_key_value(os, d.begin(), d.end(), indent);
    }
    ...
    namespace _impl
    {
        ...
        {
            os << ", ";
            fancy_print(os, std::get<sizeof...(Args) - N>(v), indent);
    ...
    std::ostream &fancy_print(std::ostream &os, std::tuple<T, Args...> const &v, int indent = 0)
    {
        os << "{ ";
        fancy_print(os, std::get<0>(v), indent);
    ...
    template <typename TI>
    std::ostream &fancy_print_array1(std::ostream &os, TI const &ib, TI const &ie, int indent)
    {
        if (ib == ie)
        {
            return os;
    ...
    template <typename TI>
    std::ostream &fancy_print_key_value(std::ostream &os, TI const &ib, TI const &ie, int indent)
    {
        if (ib == ie)
        {
            return os;
        ...
        os << "=";
        fancy_print(os, it->second, indent + 1);
        ++it;
        for (; it != ie; ++it)
        {
            os << " , " << std::endl
