...
// template <>
// Entry EntryPlugin<entry_memory>::get_attribute_raw(const std::string& name) const
// {
//     auto p = find("@" + name);
//     if (!p)
//     {
...
// template <>
// void EntryPlugin<entry_memory>::set_attribute_raw(const std::string& name, const Entry& value)
// {
...
// template <>
// std::map<std::string, Entry> EntryPlugin<entry_memory>::attributes() const
// {
