...
class BBox:
    ...
    @property
    def dimensions(self) -> ArrayType: return self._dimensions

    @property
    def is_valid(self) -> bool: return np.all(self._dimensions > 0) == True
    ...
    @property
    def center(self) -> ArrayType: return self._origin + self._dimensions*0.5
    """ center of geometry """
