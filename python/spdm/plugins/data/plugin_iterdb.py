...
def sp_read_iterdb_txt(path: str):
    ...
    entry["core_profiles/vacuum_toroidal_field/r0"]                                     = data[n:=n+1][1] # major radius of vacuum btor ref location, meters
    ...
    entry["core_profiles/vacuum_toroidal_field/b0"]                                     = data[n:=n+1][1:]#  Btor : vacuum toroidal field at rmajor, tesla
