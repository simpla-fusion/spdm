...
class Container(Node, typing.Container[_TObject]):
    ...
    def __init__(self, *args,   cache=None, **kwargs):
        ...
        self._cache: typing.Union[typing.Dict[str, typing.Any],
                                  typing.List[typing.Any]] = {} if cache is None else cache
    ...
    def _as_child(self,
        ...
        if value is _not_found_:
            ...
            elif isinstance(key, int) and isinstance(self._cache, collections.abc.Sequence):
        ...
        if not inspect.isclass(orig_class):
            pass
        elif not isinstance(value, orig_class) and default_value is not _not_found_:
            ...
            if not isinstance(self._cache, collections.abc.Sequence):
                ...
                self._cache += [_undefined_]*(key+1-len(self._cache))
